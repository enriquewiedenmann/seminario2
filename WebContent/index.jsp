	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<div class="wrap-input100 validate-input"
					data-validate="Enter password" name="inputConfrimPass"
					id="inputConfrimPass" style="display: none;">
					<span class="btn-show-pass"> <i class="zmdi zmdi-eye"></i>
					</span> <input class="input100" type="password" name="pass" id="passC">
					<span class="focus-input100" data-placeholder="Confirm Password"></span>
				</div>


				<div class="container-login100-form-btn" name="btnLogIn"
					id="btnLogIn" style="display: block;">
					<div class="wrap-login100-form-btn">
						<div class="login100-form-bgbtn"></div>
						<button id="loginBtn" class="login100-form-btn" onclick="logIn()">
							Login</button>
				...
				<div class="container-login100-form-btn" name="btnSingUP"
					id="btnSingUP" style="display: none;">
					<div class="wrap-login100-form-btn">
						<div class="login100-form-bgbtn"></div>
				...
				<div class="text-center p-t-115">
					<span class="txt1">  Don't have an account?  </span> <a
						class="txt2" href="#" onclick="camposSingUp()"> Sign Up </a>
				</div>
